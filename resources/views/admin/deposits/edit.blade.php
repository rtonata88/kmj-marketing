...
<div class="offset-md-3 row">
    <div class="col-md-8 col-sm-12">
        <div class="card">
            ...
            @endif
            {!! Form::model($deposit, array('route' => array('deposits.update', $deposit->id), 'method' => 'patch', 'class'=> 'form-horizontal')) !!}
            <div class="card-body">
                <div class="col-md-12">
                    <div class="form-group">
                        {{Form::label('investor_username', 'Investor username')}}
                        {{Form::text('investor_username', $deposit->investor->user->username, ['class' => 'form-control'])}}
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="form-group">
